...
|------|-------|--------|-------------|
| Community Node | ~87/100 | Round 1 Phase 3 ~95% complete (2026-04-24, Build F closes). Cockpit-native business switcher functional end-to-end. Directory visibility filter wired everywhere; Mycelia hidden from public. Profile Settings has editors for every previously-uneditable field. "Jobsite" replaced with "Desk" in user-visible vocabulary. Cockpit centers cleanly on wide viewports. `service_area` is now structured `array<slug>` (Lane County town list). Phase 2 state preserved: Mycelia/LocalLane/TCA anchored, Recess reparented, Red Umbrella promoted from Bari FS, sandbox archived, Bari flagged legacy. Architecture v4.1 closed (DEC-169/170/171/172/173). Migration plan resolved (DEC-175 — Pattern C+ at Phase 6). Mylane Agent v2 live. 8 App Agents + 1 Mycelia Superagent. | 2026-04-24 |
| Field Service | ~93/100 | Documents + e-sign + FieldServiceAgent live. Bari-prep (2026-04-23): two-tier template architecture shipped — system templates + business-scoped user-owned. Preview-before-commit modal on every template card. Business-first branding composition (logo/banner in merge fields, branded letterhead in DocumentDetail). Legal disclaimer on system templates. `Business.video_url` plumbing (no profile render yet). Bari's two attorney-drafted Red Umbrella contracts loaded and ready for 2026-04-24 morning meeting. | 2026-04-23 |
...
| Phase 3 | Business switcher + directory visibility + profile editors + Desk vocabulary + cockpit centering + structured service area | 🚧 ~95% (Build F closes) | 2026-04-24 | c0d7c3f, 65e3fd7, 6521232, 9598128, 47d1af2, 7c21c3e |
| Phase 3.5 | Direct doors `/b/{slug}` (DEC-171) | 🔜 Next | — | — |
| Phase 4 | Desk implementation rename + business-scoped rendering (DEC-160, DEC-156) | Pending | — | — |
| Phase 5 | Membership gate ($9/mo per entity, DEC-155) — re-tightens FSProfile/User `rls.update` | Pending | — | — |
