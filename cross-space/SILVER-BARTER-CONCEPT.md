...
> **SUPERSEDED (2026-02-11):** This concept evolved into SILVER-DIME-LAYER.md (written 2026-02-08) and DEC-045. The comparison table below still references "Punch Pass" — see COMMUNITY-PASS.md and SILVER-DIME-LAYER.md for current model. This file is retained for historical context only.
...
## Relationship to Joy Coins

> **Updated 2026-03-17:** "Punch Pass" renamed to "Joy Coins" per DEC-028. See COMMUNITY-PASS.md for current model.

Joy Coins and Silver Barter are complementary, not competing systems:

| | Joy Coins | Silver Barter |
|---|---|---|
| **Medium** | Digital coins (membership allocation) | Physical silver |
...
| **Platform role** | Facilitator (membership + revenue share) | Directory (lists participants) |
| **Revenue model** | Membership fee ($45/mo) | Business tier feature |

**Future consideration:** Could Joy Coins ever be bridged with the silver barter network? This would connect the two systems but adds significant complexity and potential regulatory concerns. Shelve for much later evaluation.
